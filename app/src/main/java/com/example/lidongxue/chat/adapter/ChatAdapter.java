...
public class ChatAdapter extends BaseAdapter {
    ...
    private   final int FRIENDS_MSG = 0;//收到对方的消息
        ...
        if(convertView==null){
            ...
            switch (type){
                case SELF_MSG:
                    ...
                    holder1.my_time=convertView.findViewById(R.id.send_name);
                ...
                case FRIENDS_MSG:
                    ...
                    holder2.your_time=convertView.findViewById(R.id.receive_name);
